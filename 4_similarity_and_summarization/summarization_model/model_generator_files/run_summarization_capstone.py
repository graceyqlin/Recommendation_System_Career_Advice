...
from data_capstone import Vocab
from batcher import Batcher
from model_capstone import SummarizationModel
from decode_capstone import BeamSearchDecoder
import util
...
# Where to find data
tf.app.flags.DEFINE_string('data_path', '/home/final/pointer-generator-master/temp_sum/temp.bin', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
#tf.app.flags.DEFINE_string('data','')
tf.app.flags.DEFINE_string('vocab_path', '/home/final/pointer-generator-master/vocab/final_model_vocab/vocab', 'Path expression to text vocabulary file.')
...
tf.app.flags.DEFINE_string('log_root', '/home/final/pointer-generator-master/log', 'Root directory for all logging.')
tf.app.flags.DEFINE_string('exp_name', 'combined_files', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')#Update this to correct exp name
