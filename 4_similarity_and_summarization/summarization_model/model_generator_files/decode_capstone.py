...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    ...
    while True:
      ...
      self.write_sum_to_file(decoded_words)
  ...
  def write_sum_to_file(self, decoded_words):
   ...
   while len(decoded_words) > 0:
    ...
    decoded_file = os.path.join('/home/final/pointer-generator-master/temp_sum/', "generated_sum.txt")
