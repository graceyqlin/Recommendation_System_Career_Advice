...
class SummarizationModel(object):
  ...
  def _add_placeholders(self):
    ...
    if hps.mode.value=="decode":
      self._dec_batch = tf.placeholder(tf.int32, [hps.batch_size.value, 1], name='dec_batch')
      self._target_batch = tf.placeholder(tf.int32, [hps.batch_size.value, 1], name='target_batch')
      self._dec_padding_mask = tf.placeholder(tf.float32, [hps.batch_size.value, 1], name='dec_padding_mask')
    else:
